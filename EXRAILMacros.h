...
#define FLASHING_RED(signal_id) OPCODE_FLASHING_RED,V(signal_id),
#define FLASHING_AMBER(signal_id) OPCODE_FLASHING_AMBER,V(signal_id),
#define FLASHING_GREEN(signal_id) OPCODE_FLASHING_GREEN,V(signal_id),
