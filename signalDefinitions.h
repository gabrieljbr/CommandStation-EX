  ...
  IFCLOSED(CP_101) \
    IFCLOSED(CP_103) \
      IFCLOSED(CP_105) \
        ...
        ENDIF \
        IFAMBER(M1_M1) \
          APPROACH_MEDIUM_TWO_HEADS(L_MAIN_M1, L_MAIN_LEAD, 110) \
        ENDIF \
      ELSE \
        APPROACH_MEDIUM_TWO_HEADS(L_MAIN_M1, L_MAIN_LEAD, 110) \
      ENDIF \
...
#define SET_RMAINM1_RMAINM2() \
  IFCLOSED(CP_102) \
    ...
    ELSE \
      IFAMBER(M1_M1_M2) \
        APPROACH_MEDIUM_TWO_HEADS(R_MAIN_M1, R_MAIN_M2, 153) \
      ELSE \
...
#define SET_M2M1LEAD() \
  IFCLOSED(CP_106) \
    IFCLOSED(YARD_EXIT) \
      IFCLOSED(CP_104) \
        IFAMBER(LEAD_L_MAIN) \
          APPROACH_MEDIUM_TWO_HEADS(M2_M1, M2_LEAD, 141) \
        ENDIF \
        IFRED(LEAD_L_MAIN) \
...
#define SET_LEADM2() \
  IFCLOSED(CP_104) \
    IFCLOSED(YARD_EXIT) \
      IFCLOSED(CP_106) \
        IFAMBER(M2_R_MAIN) \
          APPROACH_MEDIUM_TWO_HEADS(LEAD_M2, LEAD_YARD, 128) \
        ENDIF \
        IFRED(M2_R_MAIN) \
