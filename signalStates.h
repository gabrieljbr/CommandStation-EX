...
#define APPROACH_MEDIUM_TWO_HEADS(top, bottom) FLASHING_AMBER(top) RED(bottom) // flashing
#define DIVERGING_APPROACH_TWO_HEADS(top, bottom) RED(top) AMBER(bottom)
#define DIVERGING_APPROACH_MEDIUM_TWO_HEADS(top, bottom) RED(top) FLASHING_AMBER(bottom) // flashing
#define STOP_TWO_HEADS(top, bottom) RED(top) RED(bottom)
#define DIVERGING_RESTRICTED_TWO_HEADS(top, bottom) RED(top) FLASHING_RED(bottom) // flashing
